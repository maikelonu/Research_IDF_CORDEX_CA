...
#' precipitation data following Theme?l et al. (2012). To adjust the frequency, 
...
#' It constitutes a preprocess to bias correct precipitation data following Theme?l et al. (2012). 
...
adjustPrecipFreq <- function(obs, pred, threshold){
  ...
  # Theme?l (Themessl) modification (simulating rain for model dry days) 
